...
The Core Client provides stable, type-safe and raw APIs for interacting with Erebus pub/sub and messaging infrastructure. The main APIs and features include:
...
- **sequences**: Provides access to message sequences and ordering using ULID (Universally Unique Lexicographically Sortable Identifier) , useful for replay or catch-up, sorting and uniqueness.
- **namespaces/regions**: Scoping of channels and messages to logical or geographic partitions. Reference [Pub/Sub Channels](/docs/concepts/channels) for more information.
