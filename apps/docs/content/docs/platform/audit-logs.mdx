...
_[Screenshot placeholder: Audit logs interface showing recent activity]_
...
_[Screenshot placeholder: Navigation to audit logs section]_
...
_[Screenshot placeholder: Audit logs list with filters and search]_
...
_[Screenshot placeholder: Empty audit logs state]_
...
<Callout title="Retention Policy" type="info">
  The system currently retains the 100 most recent audit events per project.
  Older events are automatically removed as new events are added. Time-based
  retention policies may be introduced in future updates.
</Callout>
...
_[Screenshot placeholder: API key audit events with descriptions]_
...
_[Screenshot placeholder: Project audit events with descriptions]_
