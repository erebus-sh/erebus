---
title: Audit Logs
description: Comprehensive guide to audit logs in Erebus platform for security monitoring, compliance tracking, and activity oversight.
---

# Audit Logs

Audit logs provide complete visibility into all activities within your Erebus projects. Every significant action is automatically tracked, creating an immutable record for security monitoring, compliance requirements, and operational oversight.
...
- **Session Management**: Token generation and expiration events
...
Audit logs support various compliance frameworks:

**Regulatory Compliance**
- **SOX Requirements**: Complete audit trail for financial systems
- **GDPR Compliance**: Data access and modification tracking
- **HIPAA Requirements**: Access logging for healthcare data
- **PCI DSS**: Security event monitoring for payment systems

**Internal Policies**
- **Change Control**: Documentation of all system changes
- **Access Control**: Verification of authorization policies
- **Security Policies**: Evidence of security control effectiveness
...
### Direct Support
- **Email**: [hey@v0id.me](mailto:hey@v0id.me) for audit log questions
