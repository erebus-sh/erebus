...
_[Screenshot placeholder: Sign-in page with GitHub button]_
...
_[Screenshot placeholder: Pricing page with plan selection]_
...
<Callout title="Free Tier Available" type="note">
  Most plans include generous free usage limits, perfect for development and
  small applications.
</Callout>

## Step 3: Create Your First Project

_[Screenshot placeholder: Create project dialog with form fields]_
...
<Callout title="Project Limits" type="info">
  You can create up to 50 projects per account. Each project can have unlimited
  API keys.
</Callout>

## Step 4: Generate Your First API Key

_[Screenshot placeholder: API Keys page with create dialog]_
...
<Callout title="Environment Types" type="note">
  Currently, development and production keys have the same capabilities. The
  separation exists for organization and security best practices.
</Callout>
...
_[Screenshot placeholder: Project dashboard with navigation sidebar]_
...
_[Screenshot placeholder: Project settings page with webhook configuration]_
...
<Callout title="Webhook Requirements" type="warning">
  Webhook URLs must use HTTPS and be base URLs without paths. The system
  automatically appends `/erebus/webhook` to your configured URL.
</Callout>
...
You'll need an authentication endpoint that issues grant tokens for your clients. See [Authentication](/docs/concepts/authentication) for the full grant flow and server-side examples.

<Callout title="Authentication Required" type="info">
  Erebus requires grant tokens for authentication. See our [authentication
  guide](/docs/concepts/authentication) for detailed setup including server-side
  token issuance.
</Callout>

## Step 8: Monitor Your Application

_[Screenshot placeholder: Dashboard showing live metrics]_
