...
{
  "functions": { "app/api/erebus/[...all]/route.ts": { "maxDuration": 30 } },
  "env":
    {
...
3. **Deploy** - Each quickstart includes deployment notes for its framework
...
3. **[Core SDK Reference](/docs/sdk/core/apis)** - Full API documentation
