...
<Callout title="Beta version" type="warning">
  Erebus is in beta. The SDK APIs might change and are not guaranteed to be
  backward compatible with every update. You are welcome to try Erebus in side
  projects and share feedback. If the docs do not cover what you need, help can
  be provided directly. Reach out at [x.com/v0id_user](https://x.com/v0id_user).
</Callout>
