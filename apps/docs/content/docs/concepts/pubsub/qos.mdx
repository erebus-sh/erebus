...
In short: _fire and forget._

---

## QoS 1 – _At least once_
...
In short: _guaranteed delivery, with possible duplicates._

---

<Callout title="Note:" type="warning">
  Erebus does not currently implement QoS 2 (“exactly once”), as the additional
  handshake adds latency and complexity. For most realtime use cases, QoS 1
  combined with deduplication is the right balance of speed and reliability.
</Callout>
