...
Our SDK is live on npm (`@erebus-sh/sdk`), and the console is open for signups. More features — from advanced monitoring to global ordering options — are coming soon.
