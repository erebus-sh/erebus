...
export interface StorageKeys {
	...
	subscribers: (projectId: string, channelName: string, topic: string) => string;
	/** Key for messages: `msg:${projectId}:${channelName}:${topic}:${seq}` */
	message: (projectId: string, channelName: string, topic: string, seq: string) => string;
	...
	lastSeenSequence: (projectId: string, channelName: string, topic: string, clientId: string) => string;
}
...
export const STORAGE_KEYS: StorageKeys = {
	subscribers: (projectId: string, channelName: string, topic: string) => `subs:${projectId}:${channelName}:${topic}`,
	message: (projectId: string, channelName: string, topic: string, seq: string) => `msg:${projectId}:${channelName}:${topic}:${seq}`,
	sequence: (projectId: string, channelName: string, topic: string) => `seq:${projectId}:${channelName}:${topic}`,
	lastSeenSequence: (projectId: string, channelName: string, topic: string, clientId: string) =>
