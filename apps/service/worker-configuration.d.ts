/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e11530bc473c320d7dd52d12e40d2e7f)
// Runtime types generated with workerd@1.20251008.0 2025-07-12 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChannelV1";
	}
	interface Env {
		CACHE: KVNamespace;
		...
		EREBUS_ON_HOLD: string;
		DEBUG: string;
		CHANNEL: DurableObjectNamespace<import("./src/index").ChannelV1>;
		EREBUS_QUEUE: Queue;
	}
}
