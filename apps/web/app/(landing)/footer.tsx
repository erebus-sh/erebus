...
const footerLinks = {
  ...
  resources: [
    ...
    { label: "x", href: "https://x.com/ErebusGlobe", external: true },
    {
      label: "Blog",
      href: `${process.env.NEXT_PUBLIC_DOCS_URL}/blog`,
      external: true,
    },
    // { label: "Status", href: "https://status.erebus.sh", external: true },
  ] as FooterLink[],
  company: [
    { label: "Source Code", href: "https://github.com/erebus-sh/erebus" },
    { label: "Contact", href: "mailto:hello@erebus.sh" },
