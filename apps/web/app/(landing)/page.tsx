...
export default function HomePage() {
  return (
    <main>
      <Navbar />
      <section className="mx-4 py-20 sm:mx-6 sm:py-32 md:mx-10 md:border-x md:border-[#232322] md:py-40 lg:mx-14">
        <Spotlight />
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:text-left">
              ...
              <p className="text-muted-foreground mt-3 text-base sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                ...
                pub/sub backend on global infrastructure — fast, stateless, and
                dead simple.
              </p>
